  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", fontFamily: "'Segoe UI', sans-serif" }}>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "24px 40px 0" }}>
        <button onClick={() => setPage("properties")} style={{ background: "none", border: "none", color: "#2563eb", fontWeight: 600, fontSize: 14, cursor: "pointer", padding: 0 }}>
          ← Back to listings
        </button>
      </div>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "20px 40px 60px" }}>
        ...
        <div style={{ borderRadius: 16, overflow: "hidden", marginBottom: 28, height: 420 }}>
          <img src={details.image_url || DEFAULT_IMG} alt={details.title} style={{ width: "100%", height: "100%", objectFit: "cover" }} onError={(e) => { e.target.src = DEFAULT_IMG; }} />
        </div>
            ...
            <div style={{ background: "white", borderRadius: 12, padding: "20px 24px", border: "1px solid #e2e8f0" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                {[
                  ...
                  ["Listed on", new Date(details.created_at).toLocaleDateString("en-US")],
                ].map(([label, value]) => (
                  <div key={label}>
              ...
              <div style={{ background: "white", borderRadius: 16, padding: 24, border: "1px solid #e2e8f0" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    ...
                    {details.seller_email && <p style={{ margin: 0, fontSize: 13, color: "#64748b" }}>{details.seller_email}</p>}
                  </div>
                </div>
              </div>
            )}
